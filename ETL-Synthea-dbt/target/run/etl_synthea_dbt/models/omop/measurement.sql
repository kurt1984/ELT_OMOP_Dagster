...
FROM (
    ...
    FROM "dbt"."source"."observations" AS o
    INNER JOIN "dbt"."stg"."source_to_standard_vocab_map" AS srctostdvm
        ON srctostdvm.source_code = o.code
            ...
            AND srctostdvm.target_standard_concept = 'S'
            AND srctostdvm.target_invalid_reason IS NULL
    LEFT JOIN "dbt"."stg"."source_to_standard_vocab_map" AS srcmap1
    ...
    LEFT JOIN "dbt"."stg"."source_to_standard_vocab_map" AS srcmap2
    ...
    LEFT JOIN "dbt"."stg"."source_to_source_vocab_map" AS srctosrcvm
    ...
    LEFT JOIN "dbt"."main"."provider" AS pr 
